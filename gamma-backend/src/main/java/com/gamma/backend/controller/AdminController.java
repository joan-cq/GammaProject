...
public class AdminController {
    ...
    public ResponseEntity<List<Administrador>> listarAdministradores() {
        ...
        logService.addLog(LogService.INFO, "ADMINISTRADOR", "Se listaron los administradores.");
    ...
    public ResponseEntity<Administrador> actualizarAdministrador(@RequestBody Administrador administrador) {
        ...
        if (administradorExistente != null) {
            ...
            logService.addLog(LogService.MODIFICACION, "ADMINISTRADOR", "Se actualizó el administrador con DNI: " + administrador.getDni());
    ...
    public ResponseEntity<?> agregarAdministrador(@RequestBody Map<String, String> payload) {
        ...
        logService.addLog(LogService.CREACION, "ADMINISTRADOR", "Se agregó el administrador con DNI: " + dni);
    ...
    public ResponseEntity<?> eliminarAdministrador(@PathVariable String dni) {
        ...
        if (administrador != null) {
            ...
            logService.addLog(LogService.ELIMINACION, "ADMINISTRADOR", "Se eliminó el administrador con DNI: " + dni);
