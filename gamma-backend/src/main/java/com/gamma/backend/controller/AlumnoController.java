...
public class AlumnoController {
    ...
    public ResponseEntity<List<Alumno>> listarAlumnos() {
        ...
        logService.addLog(LogService.INFO, "ALUMNO", "Se listaron los alumnos.");
    ...
    public ResponseEntity<Alumno> actualizarAlumno(@RequestBody Map<String, Object> payload) {
        ...
        if (alumnoExistente != null) {
            ...
            logService.addLog(LogService.MODIFICACION, "ALUMNO", "Se actualizó el alumno con DNI: " + dni);
    ...
    public ResponseEntity<?> agregarAlumno(@RequestBody Map<String, String> payload) {
        ...
        logService.addLog(LogService.CREACION, "ALUMNO", "Se agregó el alumno con DNI: " + dni);
    ...
    public ResponseEntity<?> eliminarAlumno(@PathVariable String dni) {
        ...
        if (alumno != null) {
            ...
            logService.addLog(LogService.ELIMINACION, "ALUMNO", "Se eliminó el alumno con DNI: " + dni);
