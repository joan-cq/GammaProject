...
public class AnioEscolarController {
    ...
    public ResponseEntity<List<AnioEscolar>> listarAniosEscolares() {
        ...
        logService.addLog(LogService.INFO, "ANIO_ESCOLAR", "Se listaron los años escolares.");
    ...
    public ResponseEntity<?> actualizarEstado(@RequestBody Map<String, Object> payload) {
        ...
        logService.addLog(LogService.MODIFICACION, "ANIO_ESCOLAR", "Se actualizó el estado del año escolar " + anio.getAnio() + " a " + nuevoEstado);
