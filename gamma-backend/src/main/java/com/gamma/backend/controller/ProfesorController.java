...
public class ProfesorController {
    ...
    public ResponseEntity<List<Map<String, Object>>> listarProfesores() {
        ...
        logService.addLog(LogService.INFO, "PROFESOR", "Se listaron los profesores.");
    ...
    public ResponseEntity<Profesor> actualizarProfesor(@RequestBody Map<String, Object> payload) {
        ...
        if (profesorExistente != null) {
            ...
            logService.addLog(LogService.MODIFICACION, "PROFESOR", "Se actualizó el profesor con DNI: " + dni);
    ...
    public ResponseEntity<?> agregarProfesor(@RequestBody Map<String, String> payload) {
        ...
        logService.addLog(LogService.CREACION, "PROFESOR", "Se agregó el profesor con DNI: " + dni);
    ...
    public ResponseEntity<?> eliminarProfesor(@PathVariable String dni) {
        ...
        if (profesor != null) {
            ...
            logService.addLog(LogService.ELIMINACION, "PROFESOR", "Se eliminó el profesor con DNI: " + dni);
