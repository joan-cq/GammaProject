...
public class CursoController {
    ...
    public ResponseEntity<List<Curso>> listarCursos() {
        ...
        logService.addLog(LogService.INFO, "CURSO", "Se listaron los cursos.");
    ...
    public ResponseEntity<?> agregarCurso(@RequestBody Curso curso) {
        ...
        logService.addLog(LogService.CREACION, "CURSO", "Se agregó el curso: " + curso.getNombre());
    ...
    public ResponseEntity<?> actualizarCurso(@PathVariable String codigoCurso, @RequestBody Curso cursoDetails) {
        ...
        logService.addLog(LogService.MODIFICACION, "CURSO", "Se actualizó el curso con código: " + codigoCurso);
    ...
    public ResponseEntity<?> toggleCurso(@PathVariable String codigoCurso) {
        ...
        cursoRepository.save(cursoExistente);
        logService.addLog(LogService.MODIFICACION, "CURSO", "Se cambió el estado del curso con código: " + codigoCurso);
